...
| Camera pulse | `node index.mjs` on the laptop webcam (30 s + 20 s settle) | `node index.mjs --replay test/fixtures/capture_real.json` posts the real Saturday capture (68.5 bpm) | Yes, real capture replayed |
